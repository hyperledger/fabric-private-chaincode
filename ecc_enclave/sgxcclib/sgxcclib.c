...
extern void get_state_by_partial_composite_key(const char *comp_key, uint8_t *values,
    uint32_t max_len, uint32_t *values_len, cmac_t *cmac, void *ctx);
extern void get_state(const char *key, uint8_t *val, uint32_t max_val_len, uint32_t *val_len,
    cmac_t *cmac, void *ctx);
...
int sgxcc_invoke(enclave_id_t eid, const char *args, const char *pk, uint8_t *response,
    uint32_t response_len_in, uint32_t *response_len_out, ec256_signature_t *signature, void *ctx)
{
    int enclave_ret;
...
/* OCall functions */
void ocall_get_state(const char *key, uint8_t *val, uint32_t max_val_len, uint32_t *val_len,
...
void ocall_get_state_by_partial_composite_key(const char *key, uint8_t *bids_bytes,
    uint32_t max_len, uint32_t *bids_bytes_len, sgx_cmac_128bit_tag_t *cmac, void *ctx)
{
