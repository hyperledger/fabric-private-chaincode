...
import (
	...
	"github.com/hyperledger-labs/fabric-private-chaincode/ercc/registry/mocks"
...
//go:generate counterfeiter -o mocks/verifier.go -fake-name AttestationVerifier . attestationVerifier
type attestationVerifier interface {
	attestation.VerifierInterface
}

//go:generate counterfeiter -o mocks/evaluator.go -fake-name PolicyEvaluator . policyEvaluator
type policyEvaluator interface {
	utils.PolicyEvaluatorInterface
}

var (
	mrenclave              = `98aed61c91f258a37c68ed4943297695647ec7bbe6008cc111b0a12650ebeb91`
	channelId              = "MY_TEST_CHANNEL"
	chaincodeId            = "SOME_CHAINCODE_ID"
...
func TestRegisterEnclave(t *testing.T) {
	...
	verifier := &mocks.AttestationVerifier{}
	verifier.VerifyEvidenceReturns(nil)

	pe := &mocks.PolicyEvaluator{}
	...
	pe.EvaluateCreatorIdentityReturns(nil)
