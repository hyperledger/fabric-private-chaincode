...
func (id *PolicyEvaluator) EvaluateCreatorIdentity(creatorIdentityBytes []byte, ownerIdentityBytes []byte) error {
	...
	fmt.Printf("creator: %s owner: %s", creatorMSP, ownerMSP)
