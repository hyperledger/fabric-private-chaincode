...
type Credentials struct {
	...
	SerializedAttestedData *any.Any `protobuf:"bytes,1,opt,name=serialized_attested_data,json=serializedAttestedData,proto3" json:"serialized_attested_data,omitempty"`
