...
type SignedCCKeyRegistrationMessage struct {
	...
	SerializedCckeyRegMsg *any.Any `protobuf:"bytes,1,opt,name=serialized_cckey_reg_msg,json=serializedCckeyRegMsg,proto3" json:"serialized_cckey_reg_msg,omitempty"`
...
type SignedExportMessage struct {
	...
	SerializedExportMsgBytes *any.Any `protobuf:"bytes,1,opt,name=serialized_export_msg_bytes,json=serializedExportMsgBytes,proto3" json:"serialized_export_msg_bytes,omitempty"`
